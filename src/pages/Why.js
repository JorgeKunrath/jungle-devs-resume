  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>2. Quality</p>
        <p>
          I went to a Jungle Devs talk about UI/UX in 2019 (when I started to being tamed). This
          talk was presented by two designers. One of these I also had a class in UFSC and he always
          presented amazying works (his <i>TCC</i> is formidable!). Considering the attention that
          is given to design, alied to the culture of continuous growth, the products at Jungle must
          be awesome! And this is exactly the kind of place I want to work at.
        </p>
        ...
        <p>
          <Link to="/learn">So you enjoy learning?</Link>
        </p>
      </div>
      <img
        src="https://i5.walmartimages.com/asr/0ca514a3-0d2c-4334-8064-30d46b2cda55.1331321894058fdb48862d9735807511.jpeg"
        alt=""
        width="300"
      />
    </div>
